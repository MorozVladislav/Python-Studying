...
class SSHClient(object):
    ...
    def __init__(self, host=None, username=None, password=None, allow_unknown_hosts=False, environment=None):
        self.host = host
    ...
    def add_system_known_hosts(self, path):
    ...
    def connect(self, *args, **kwargs):
        try:
            ...
            message = 'Failed to connect {}'.format(self.host)
            logger.error(message)
